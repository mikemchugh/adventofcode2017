...
class CountBetweenDuplicates extends FlatSpec with Matchers {
  "countBetweenDuplicates" should "be 4 when input is 0 2 7 0" in {
    Day06.countBetweenDuplicates(Vector(0, 2, 7, 0)) shouldEqual 4
  }

  "countBetweenDuplicates" should "get me a star" in {
    Day06.countBetweenDuplicates(Vector(4, 10, 4, 1, 8, 4, 9, 14, 5, 1, 14, 15, 0, 15, 3, 5)) shouldEqual 8038
  }
}